...
* In a terminal window, navigate into the cloned repository folder ("northspyre-take-home") and run the following command: pip install -r requirements.txt
* cd into /backend and run the following command to start the Flask app: flask run
* Open a new terminal window at the top level directory of the project and run the following command: npm start
* This should open a webpage at http://localhost:3000/ with a task manager on it

Assumption* npm is intalled
